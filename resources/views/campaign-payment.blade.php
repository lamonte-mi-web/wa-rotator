                            ...
                            <table id="example" class="table table-striped table-bordered custom-table" style="width:100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="#" class="text-promary">
                                                x
                                            </a>
                                        </td>
                                        <td class="text-center">
                                            <div class="button-container d-flex gap-2 text-center" >
                                            <a href="#" class="btn-icon btn-white" title="View Details">
                                                <i class="bx bx-info-circle" style="color: black;"></i>
                                            </a>
                                            <a href="#" class="btn-icon btn-white" title="Edit Campaign">
                                                <i class="bx bx-edit" style="color: black;"></i>
                                            </a>
                                                <form id="deleteCampaignForm" action="#" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="button" class="btn-icon btn-white" title="Delete Campaign" onclick="confirmDeleteCampaign('')">
